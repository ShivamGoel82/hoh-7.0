...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-primary-dark text-neutral py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#register" className="hover:text-accent transition-colors duration-200">Register</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <a href="mailto:contact@hackonhills.dev" className="text-accent hover:underline">contact@hackonhills.dev</a>
          </div>
        </div>
